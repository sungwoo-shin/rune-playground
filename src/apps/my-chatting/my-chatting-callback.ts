...
class ChatItemView extends View<TChatItemViewProps> {
  ...
  private handleRemoveButtonClick() {
    ...
    // });
    this.data.onRemoveButtonClick(this.data.chat.id);
  }
...
class ChattingPage extends View<ChattingPageViewProps> {
  private chatListView = new ChatListView(
    this.data.chats.map((chat) => ({
      chat,
      me: this.data.me,
      onEditButtonClick: this.handleChatEditButtonClick.bind(this),
      onRemoveButtonClick: this.handleChatRemoveButtonClick.bind(this),
    }))
  );
  ...
  private handleChatRemoveButtonClick(chatIdToRemove: string) {
  ...
  private handleChatEditButtonClick(chatIdToEdit: string) {
...
document
  .getElementById("my-chatting-callback")!
